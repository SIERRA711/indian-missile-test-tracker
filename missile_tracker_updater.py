...
FAMILY_RULES = [
    ...
    ("VSHORAD",     "Base",     "Surface-to-Air",       ["vshorad", "very short range"]),
    # CUAS
    ("Bhargavastra","Base",     "Counter-UAS (CUAS)",   ["\\bbhargavastra\\b", "counter.?swarm"]),
    # Anti-tank
    ("SFDR",        "Base",     "Air-to-Air",           ["\\bsfdr\\b", "solid fuel ducted"]),
